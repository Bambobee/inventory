                ...
                <div class="card-body border-dashed-bottom pb-3">
                  <div class="row d-flex justify-content-between">
                    <div class="col-auto">
                      ...
                      <h5 class="mt-2 mb-0 fs-14">Today's Total Sales</h5>
                    </div>
                    <!--end col-->
                ...
                <div class="card-body">
                  <div class="row d-flex justify-content-center">
                    <div class="col-12 col-md-6">
                      <h2 class="fs-22 mt-0 mb-1 fw-bold">UGX 8365.00</h2>
                ...
                <div class="card-body border-dashed-bottom pb-3">
                  <div class="row d-flex justify-content-between">
                    <div class="col-auto">
                      ...
                      <h5 class="mt-2 mb-0 fs-14"> Today's Total Purchase</h5>
                    </div>
                    <!--end col-->
                    <div class="col align-self-center">
                ...
                <div class="card-body border-dashed-bottom pb-3">
                  <div class="row d-flex justify-content-between">
                    <div class="col-auto">
                      ...
                      <h5 class="mt-2 mb-0 fs-14">Sales</h5>
                    </div>
                    <!--end col-->
                    <div class="col align-self-center">
                      <div id="line-1" class="apex-charts float-end"></div>
                ...
                <div class="card-body border-dashed-bottom pb-3">
                  <div class="row d-flex justify-content-between">
                    <div class="col-auto">
                      ...
                      <h5 class="mt-2 mb-0 fs-14">Purchases</h5>
                    </div>
                    <!--end col-->
                    <div class="col align-self-center">
                      <div id="line-2" class="apex-charts float-end"></div>
                ...
                <div class="card-body border-dashed-bottom pb-3">
                  <div class="row d-flex justify-content-between">
                    <div class="col-auto">
                      ...
                      <h5 class="mt-2 mb-0 fs-14">Sales Returned</h5>
                    </div>
                    <!--end col-->
                    <div class="col align-self-center">
                      <div id="line-1" class="apex-charts float-end"></div>
                ...
                <div class="card-body border-dashed-bottom pb-3">
                  <div class="row d-flex justify-content-between">
                    <div class="col-auto">
                      ...
                      <h5 class="mt-2 mb-0 fs-14">Purchase Returned</h5>
                    </div>
                    <!--end col-->
                    <div class="col align-self-center">
                      <div id="line-1" class="apex-charts float-end"></div>
