                                ...
                                <table class="table mb-0 checkbox-all" id="purchase_table">
                                  ...
                                  foreach ($purchases as $index => $purchase): ?>
                                        <tr>
                                            ...
                                            <td>UGX <?php echo htmlspecialchars($purchase['due']); ?></td>
                                            <td>
                                                <?php
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                        ...
                                                        <li><a class="dropdown-item" href="#" data-bs-toggle="modal"
                                                                data-bs-target="#show<?php echo htmlspecialchars($purchase['id']); ?>">Show
                                                                Payments</a></li>
                                                        <li><a class="dropdown-item" href="#">Download PDF</a></li>
                                                        <li><a class="dropdown-item" href="#">Purchase Returned</a></li>
                                                        <?php endif; ?>

                                                        <!-- Display "Create Payment" option only if payment status is not 'Paid' -->
                                                        <?php if ($purchase['payment_status'] !== 'Paid'): ?>
                                                        <li><a class="dropdown-item" href="#" data-bs-toggle="modal"
                                                                data-bs-target="#addBoard<?php echo htmlspecialchars($purchase['id']); ?>">Create
                                                                Payments</a></li>
                                                        <?php endif; ?>

                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="backend/delete_purchase.php?id=<?php echo $purchase['id']; ?>"
                                        ...
                                        include('backend/show_payment.php');
                                         include('backend/create_payment.php');
                                endforeach; ?>
                                    </tbody>
                                </table>
                            </div>
