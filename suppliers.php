                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto">                                         
                                        <div class="col-auto">
                                            <button type="button" class="btn btn-primary"  data-bs-toggle="modal" data-bs-target="#addBoard"><i class="fa-solid fa-plus me-1"></i> Add Supplier</button>
                                          </div>
                                    </div><!--end col-->
                                </div><!--end row-->                                  
                            </div><!--end card-header-->
                                ...
                                <div class="table-responsive">
                                  ...
                                  foreach ($suppliers as $index => $supplier): ?>
                                            ...
                                            <td><?php echo htmlspecialchars($supplier['suplier_id']); ?></td>
                                                <td class="d-flex align-items-center">
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-grow-1 text-truncate"> 
                                                            <h6 class="m-0"><?php echo htmlspecialchars($supplier['name']); ?></h6>
                                                            <a href="#" class="fs-12 text-primary"><?php echo htmlspecialchars($supplier['email']); ?></a>                                                                                           
                                                        </div><!--end media body-->
                                                    </div>
                                                </td>
                                                ...
                                                <td class="text-end">                                                       
                                                <a href="#"  data-bs-toggle="modal" data-bs-target="#editSupplier<?php echo htmlspecialchars($supplier['id']); ?>"><i class="las la-pen text-primary fs-18"></i></a>
                                          <a href="backend/delete_supplier.php?id=<?php echo $supplier['id']; ?>" onclick="return confirm('Are you sure you want to delete this supplier?');">
