                                                ...
                                                <td class="d-flex align-items-center">
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-grow-1 text-truncate"> 
                                                            <h6 class="m-0">IT Supplier</h6>
                                                            <a href="#" class="fs-12 text-primary">dummy@gmail.com</a>                                                                                           
                                                        </div><!--end media body-->
                                                    </div>
                                                </td>
                                                
                                                <td><a href="#" class="text-body text-decoration-underline">SUP_415</a></td>
                                                <td><a href="#" class="text-body text-decoration-underline">075225855</a></td>
                                                <td><a href="#" class="text-body text-decoration-underline">Matugga</a></td>
                                                <td>9/25/2024</td>
                                                <td>ugx 1000</td>
                                                <td>ugx 1000</td>
